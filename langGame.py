...
TemplateRoom4 ="""สร้างคำใบ้สำหรับเกม Escape Room โดยสถานที่เป็นบ้าน ผู้เล่นรับบทเป็น {occupations} และต้องแก้ปริศนา 2 ปริศนาทำถึงจะออกจากบ้านหลังนี้ได้โดยที่ปริศนาจะรับ inout เป็นตัวเลข 4 หลัก ปริศนาที่ 1 แก้สมการอย่างง่าย ปริศนาที่ 2 แก้ปริศนาทจากการเล่นซูโดกุ และต้องมีคำใบ้เพื่อล็อกออกปริศนา

# ภายใน story เป็นเนื้อเรื่องสั้นๆ ที่เป็นการพูดกับตัวเองเช่น "วันนี้ฉันได้รับภาระกิจเพื่อมาสำรวจในนามนักสืบ  ..."

# ภายใน selfReminders เป็นคำพูดสำหรับการใบ้โดยแบ่งเป็น 2 ส่วน 1. puzzle สมาการตั้งแต่ srd1 ถึง srd5 เช่น "เอ๊ะ?!...บนกระดาษมีสัญลักษณะแบบเดียวกับตรงที่กรอกรหัสเลย" และ 2. puzzle sudoku ตั้งแต่ srd6 ถึง srd10  เช่น "อืมม...กระดานตรงนี้คล้ายๆ เกมซูโดกุเลยแฮะ"

ปริศนาที่ 1 สร้างสมการ 4 ข้อ โดยแต่ละข้อมีตัวแปร A, B, C, D, ... เป็นจำนวนเต็มบวกเท่านั้น (1 ถึง 9)  
- ในแต่ละข้อให้มีสมการหลักและสมการเงื่อนไขย่อย เช่น  
  "description1_1": "B + C = 7"  
  "hint1_1": "B = 2"  
  "solutionLogic1_1": "จาก A + B + C = 12 หา A"  
- คำตอบของแต่ละข้อจะต้องเป็นจำนวนเต็มบวกระหว่าง 1 ถึง 9  
- AI ต้องคำนวณและระบุคำตอบที่แน่นอนใน finalCode1 โดย finalCode1 ประกอบด้วยตัวเลขคำตอบ 4 ตัวตามลำดับจาก solutionLogic1_1 ถึง solutionLogic1_4  
- ห้ามให้ผู้เล่นต้องลองแทนค่าหรือสุ่มเลขเอง  
- ทุกสมการและคำตอบต้องสอดคล้องกันครบถ้วน

ปริศนาที่ 2 ซูโดกุ
สร้าง Sudoku ขนาด 4x4 ที่ถูกต้องตามกติกา (ใช้เลข 1–4 เท่านั้น) ดังนี้:
ทุกแถวห้ามมีเลขซ้ำ
ทุกคอลัมน์ห้ามมีเลขซ้ำ
แต่ละกรอบ 2x2 (4 กรอบย่อย) ห้ามมีเลขซ้ำ
ให้คุณสร้าง กระดาน Sudoku 4x4 แบบเต็ม (4 แถว x 4 คอลัมน์) ให้ถูกต้องก่อน แล้วจึงนำเลขจากกระดานนั้นมาแยกเป็น clues2 โดยใส่ค่าลงในช่องของกรอบย่อยทั้ง 4 ดังนี้:

กรอบย่อยซ้ายบน (ช่อง 2x2 แถว 1-2, คอลัมน์ 1-2)
"location2_1": ช่องซ้ายบน
"description2_1": ช่องขวาบน
"hint2_1": ช่องซ้ายล่าง
"solutionLogic2_1": ช่องขวาล่าง

กรอบย่อยขวาบน (แถว 1-2, คอลัมน์ 3-4)
"location2_2": ช่องซ้ายบน
"description2_2": ช่องขวาบน
"hint2_2": ช่องซ้ายล่าง
"solutionLogic2_2": ช่องขวาล่าง

กรอบย่อยซ้ายล่าง (แถว 3-4, คอลัมน์ 1-2)
"location2_3": ช่องซ้ายบน
"description2_3": ช่องขวาบน
"hint2_3": ช่องซ้ายล่าง
"solutionLogic2_3": ช่องขวาล่าง

กรอบย่อยขวาล่าง (แถว 3-4, คอลัมน์ 3-4)
"location2_4": ช่องซ้ายบน
"description2_4": ช่องขวาบน
"hint2_4": ช่องซ้ายล่าง
"solutionLogic2_4": ช่องขวาล่าง

# ภายใน finalCode1 ให้รวมตัวเลขคำตอบของสมการทั้ง 4 ข้อเรียงตามลำดับ  
# ภายใน finalCode2 ให้นำเอาตัวเลขจาก hint2_1 location2_2  description2_3 solutionLogic2_4 มาใส่ตามลำดับ
