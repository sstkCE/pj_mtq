...
ตอบในรูปแบบ JSON: {{
 "roleAndStory": "เรื่องราวเป็นบทพูดกับตัวเอง”", 
 "reasonDoing1": {{
 ...
 "reasonDoing4": {{ 
  ...
  "easy": {{
   "answer": "...",
    "hint1": "ให้คำใบ้สำหรับ 'หลักที่ 1' ของรหัส PIN ซึ่งคำตอบจะเป็นตัวเลข 0-9 เท่านั้น พร้อมอธิบายด้วยเหตุผลหรือข้อมูลจากฉากหรือวัตถุว่า ทำไมหลักแรกถึงเป็นเลขนี้",
    "hint2": "ให้คำใบ้สำหรับ 'หลักที่ 2' ของรหัส PIN ด้วยหลักเหตุผลเช่นเดียวกัน",
    "hint3": "ให้คำใบ้สำหรับ 'หลักที่ 3'...",
    "hint4": "ให้คำใบ้สำหรับ 'หลักที่ 4'..."
  }}, 
  "normal": {{
   "answer": "...",
    "hint1": "ให้คำใบ้สำหรับ 'หลักที่ 1' ของรหัส PIN ซึ่งคำตอบจะเป็นตัวเลข 0-9 เท่านั้น พร้อมอธิบายด้วยเหตุผลหรือข้อมูลจากฉากหรือวัตถุว่า ทำไมหลักแรกถึงเป็นเลขนี้",
...
"""
# 
TemplateRoom2= """ช่วยสร้างเรื่องราวสำหรับเกมโดยผู้เล่นมีบทบาทโดยเป็น {occupation} ภายในอุโมงท่อน้ำที่ลึกลับ แนว Escape room ให้ผู้เล่นโดยเหตุใดต้องทำ 4 สิ่งนี้  
1.ต่อ box ข้ามสายน้ำ 
2.หยิบถังในห้องไปวางเพื่อเติมระยะห่างระหว่างบรรไดเพื่อออกห้อง 
3.ฝ่าไปกลางเขาวงกตสังเกตเลขบนเสื้อตัวตลก 5 ตัว และนำมากรอกแท่นกลางเขาวงกต เพื่อเอากุญแจ 
4.สร้าง puzzle จากวัตถุต่อไปนี้ 
...
"puzzle4": {{
 "story": "บทพูดที่นำพาให้มาทำ puzzle นี้ต้องเป็นบทพูดกับตัวเอง",
 "easy": {{
