...
- สร้างสมการ 4 ข้อ
- แต่ละข้อมี 
  1. description1_x เป็นสมการ 2 ตัวแปร เช่น "B + C = 7"
  2. hint1_x กำหนดค่าตัวแปรหนึ่ง เช่น "B = 3"
  3. solutionLogic1_x เป็นสมการหลักที่มีตัวแปรเพิ่มเติม เช่น "จาก A + B + C = 14 หา A"
- ตัวแปร A ถึง I ใช้ต่างกันในแต่ละข้อ
- คำตอบใน solutionLogic1_x ต้องเป็นตัวแปรเดียวที่ต้องหา
- คำตอบเป็นจำนวนเต็มบวก 1–9
- สมการทุกข้อสอดคล้องกันและไม่ให้ผู้เล่นต้องลองแทนค่าหรือเดาเอง
...
สุดท้ายให้รวมตัวเลขคำตอบของสมการทั้ง 4 ข้อเรียงตามลำดับเป็น finalCode1
