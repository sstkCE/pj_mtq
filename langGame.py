...
"""
TemplateRoom1="""ช่วยคิดเรื่องราวพร้อมบทพูดของ {occupations} ความยาวไม่เกิน 500 ตัวอักษร โดยที่สถานการณ์ตอนนี้คือยานเกิดอุบัติเหตุก่อนหน้า และเมื่อเกิดมีอุกกาบาตกำลังจะพุ่งชนยาน ต้องเปิดระบบป้องกันยาน
