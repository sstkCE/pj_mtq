...
TemplateRoom4 ="""สร้างคำใบ้สำหรับเกม Escape Room โดยสถานที่เป็นบ้าน ผู้เล่นรับบทเป็น {occupations} และต้องแก้ปริศนา 2 ปริศนาทำถึงจะออกจากบ้านหลังนี้ได้โดยที่ปริศนาจะรับ input เป็นตัวเลข 4 หลัก

ปริศนา 1 (สมการ):
สร้างสมการ 4 ข้อสำหรับปริศนาในรูปแบบนี้:  
- แต่ละข้อมีสมการ 2 ข้อเกี่ยวกับตัวแปร 3 ตัว (A ถึง I ไม่ซ้ำกันระหว่างข้อ)  
- มีคำใบ้กำหนดค่าของตัวแปรหนึ่งตัวในแต่ละข้อ  
- สมการ solutionLogic1_x ให้หาเฉพาะค่าของตัวแปรเดียว  
- ผลลัพธ์ของ solutionLogic1_1 ถึง solutionLogic1_4 ต้องเป็นจำนวนเต็มบวก และได้ค่า 7, 7, 5, 1 ตามลำดับ  
- สมการต้องสอดคล้องกัน ไม่ขัดแย้ง  
- ห้ามเฉลยคำตอบ  

ปริศนา 2 (Sudoku 4x4):
- สร้างกระดาน Sudoku 4x4 ที่ถูกต้องตามกติกา คือ เลข 1–4 จะต้องไม่ซ้ำกันในแต่ละแถว คอลัมน์ และกรอบย่อย 2x2
- ใช้กระดาน Sudoku นี้จริง ๆ เพื่อสร้าง clues2 โดยแยกค่าตามกรอบย่อย 2x2 ดังนี้:
  - location2_X: ช่องซ้ายบนในกรอบ 2x2 (เลข 1–4)
  - description2_X: ช่องขวาบนในกรอบ 2x2 (เลข 1–4)
  - hint2_X: ช่องซ้ายล่างในกรอบ 2x2 (เลข 1–4)
  - solutionLogic2_X: ช่องขวาล่างในกรอบ 2x2 (เลข 1–4)
- โปรดตรวจสอบว่า clues2 ทุกตัวเลขไม่มีการซ้ำในแถว คอลัมน์ และกรอบ 2x2 อย่างเคร่งครัด

เรื่องราว (story):
- ให้สร้างเป็นบทพูดกับตัวเองสั้น ๆ เช่น "วันนี้ฉันได้รับภารกิจเพื่อมาสำรวจในนามนักสืบ..."

คำพูดเตือนตัวเอง (selfReminders):
- สร้างคำพูดใบ้แบ่งเป็น 2 ส่วน:
  1. คำใบ้สำหรับสมการ (srd1 ถึง srd5) เช่น "เอ๊ะ?!...บนกระดาษมีสัญลักษณะแบบเดียวกับตรงที่กรอกรหัสเลย"
  2. คำใบ้สำหรับ Sudoku (srd6 ถึง srd10) เช่น "อืมม...กระดานตรงนี้คล้ายๆ เกมซูโดกุเลยแฮะ"

ภายใน finalCode1 คำตอบที่คำนวณจาก solutionLogic1_1, solutionLogic1_2, solutionLogic1_3, solutionLogic1_4 ตามลำดับ
และรวมตัวเลขจาก hint2_1, location2_2, description2_3, solutionLogic2_4 ตามลำดับเป็น finalCode2
