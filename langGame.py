...
TemplateRoom4="""สร้างคำใบ้สำหรับเกม Escape Room VR ที่ใช้ฉากบ้านธรรมดา รับบทเป็น{} โดยผู้เล่นต้องหาตัวเลข 4 หลักจากคำใบ้เพื่อล็อกออกจากบ้าน ผู้เล่นไม่สามารถหยิบจับสิ่งของได้ และใช้แค่การสังเกต, วิเคราะห์ และจดจำเบาะแส
